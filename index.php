...
<table name="contenido" id="contenido" width='100%' align="center" cellpadding="0" cellspacing="0" border="0">
  <tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" height="54"  background="<?=$html_root."/imagenes/fondo1.jpg"?>" >
			<tr>
				<td width="375">
				<img border="0" src="<?=$root1?>" width="50" height="50">
				<td>
				...
				<td width="54" align="center">
					<a href="http://programasumar.com.ar/sistemas/faq.php" target="_blank">
						<img border="0" src="<?=$html_root?>/imagenes/ayuda.gif" width="43" height="43" alt="<?=$titulo_eventos?>">
					</a>
				</td>
				<td width="54" align="center">
					<a href="<?=$link?>" target="frame2">
						<img border="0" src="<?=$html_root?>/imagenes/sugerencias.gif" width="43" height="43" alt="<?=$titulo_eventos?>">
					</a>
				</td>
				<td width="54" align="center">
					<a href="<?=$onclick?>">
						<img border="0" src="<?=$html_root?>/imagenes/salir.gif" width="43" height="43" alt="Salir">
					</a>
				</td>
			</tr>
		</table>
