...
function firma_mail(){
	...
	$confiden.="propiedad exclusiva de PROGRAMA SUMAR y/o amparada por el secreto profesional.\n";
	$confiden.="El acceso no autorizado, uso, reproducción, o divulgación esta prohibido.\n";
	return $confiden;
}

function encabezado_mail(){
	$confiden="SISTEMA CALIDAD 2.0\n\n";	
	return $confiden;
}
...
function enviar_mail($para,$paracc,$parabcc,$asunto,$contenido,$adjunto,$path,$htmlflag=1){
 ...
 $mail->Timeout=50; 
 $mail->From = "calidad@sumar.gov.ar";
 $mail->FromName = "Sistema Calidad";
 $mail->AddAddress($para,$para);
 $mail->Subject = "Sistema Notificaciones Calidad - ".$asunto;
