...
<table border=0 width=50% cellspacing=2 cellpadding=2 bgcolor='<?=$bgcolor3?>' align=center>
  ...
  <tr>
    <td align=right id=mo><a id=mo href='<?=encode_link("usr_areas_listado.php",array("sort"=>"1","up"=>$up))?>' >Login</a></td>      	
    <td align=right id=mo><a id=mo href='<?=encode_link("usr_areas_listado.php",array("sort"=>"2","up"=>$up))?>' >Nombre y Apellido</a></td>      	
     </tr>
  <?
   while (!$result->EOF) {
