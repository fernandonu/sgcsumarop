...
<table align="center" border="1">
 <tr>
   <td colspan="2" align="center" id="mo">Queja/Consulta</td>
 </tr>
 <tr>
   <td colspan="2" align="right">Numero: <?=$result->fields['id_queja'] ?></td>
 </tr>
 <tr>
 ...
 <tr>  
   <td>Sector al que Pertenece: <input name="mail" type="text" size="50" value="<?=$result->fields['mail'] ?>"></td>
 </tr>
</tr>
