...
variables_form_busqueda("exd_listado_dep");
...
expedientes.expediente.id_estado,
...
INNER JOIN expedientes.usu_area ON expedientes.usu_area.id_area = expedientes.expediente.area_actual";
...
if ($cmd=="activos")
    $where_tmp=" expedientes.expediente.estado_simple = 'a' and usu_area.id_usuario='$id_usuario' and (estado.desc_estado<>'ARCHIVADO')";
if ($cmd=="archivados")
    $where_tmp=" expedientes.expediente.estado_simple = 'a' and usu_area.id_usuario='$id_usuario' and (estado.desc_estado='ARCHIVADO')";
...
<form name=form1 action="exd_listado_dep.php" method=POST>
...
<table border=0 width=100% cellspacing=2 cellpadding=2 bgcolor='<?=$bgcolor3?>' align='center'>
  ...
  <tr>
    <td align=right id='mo'><a id=mo href='<?=encode_link("exd_listado_dep.php",array("sort"=>"1","up"=>$up))?>'>Numero</a></td>        
    <td align=right id='mo'><a id=mo href='<?=encode_link("exd_listado_dep.php",array("sort"=>"2","up"=>$up))?>'>Extracto</a></td>      	
    <td align=right id='mo'><a id=mo href='<?=encode_link("exd_listado_dep.php",array("sort"=>"3","up"=>$up))?>'>Fecha de Creacion</a></td>
    <td align=right id='mo'><a id=mo href='<?=encode_link("exd_listado_dep.php",array("sort"=>"4","up"=>$up))?>'>Area Genera</a></td>
    <td align=right id='mo'>Area Actual</td>
    <td align=right id='mo'><a id=mo href='<?=encode_link("exd_listado_dep.php",array("sort"=>"5","up"=>$up))?>'>Estado</a></td>       
    <td align=right id='mo'><a id=mo href='<?=encode_link("exd_listado_dep.php",array("sort"=>"6","up"=>$up))?>'>Prioridad</a></td>       
    <td align=right id='mo'><a id=mo href='<?=encode_link("exd_listado_dep.php",array("sort"=>"7","up"=>$up))?>'>Tramite</a></td>       
    <td align=right id='mo'>Acceso</td>       
  </tr>
 <?
   while (!$result->EOF) {
	$ref = encode_link("exd_nuevo.php",array("id_expediente"=>$result->fields['id_expediente'],"pagina_viene"=>"exd_listado_dep.php"));
