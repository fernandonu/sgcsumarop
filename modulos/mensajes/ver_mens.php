    ...
    <tr> 
      ...
      <td valign="top"> 
        <b><? //obtengo el nombre del usuario dado el login 
		 ...
		 echo $nombre_o->fields['nombre'].' '.$nombre_o->fields['apellido'].' ('.$result->fields['usuario_origen'].')';
      ...
      <td valign="top"> 
        <b><? $sql="select nombre, apellido from usuarios where login='".$result->fields['usuario_destino']."';";
		      ...
		      echo $nombre_d->fields['nombre'].' '.$nombre_d->fields['apellido'].' ('.$result->fields['usuario_destino'].')';
